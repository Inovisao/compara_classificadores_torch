...
def get_architecture(architecture, in_channels, out_classes, pretrained):
    ...
    def lambda_resnet26rpt_256(in_channels, out_classes, pretrained):
    ...
    def vit_relpos_base_patch32_plus_rpn_256(in_channels, out_classes, pretrained):
    ...
    def sebotnet33ts_256(in_channels, out_classes, pretrained):
    ...
    def lamhalobotnet50ts_256(in_channels, out_classes, pretrained):
    ...
    def swinv2_base_window16_256(in_channels, out_classes, pretrained):
    ...
    def swinv2_cr_base_224(in_channels, out_classes, pretrained):
    ...
    def convnext_base(in_channels, out_classes, pretrained):
        """
    ...
    def resnet18(in_channels, out_classes, pretrained):
        """
    ...
    def resnet50(in_channels, out_classes, pretrained):
    ...
    def resnet101(in_channels, out_classes, pretrained):
    ...
    def mobilenetV3(in_channels, out_classes, pretrained):
    ...
    def densenet201(in_channels, out_classes, pretrained):
    ...
    def ielt(in_channels, out_classes, pretrained):
    ...
    def default_siamese(in_channels, out_classes, pretrained):
    ...
    # Chama a função adequada e retorna o modelo.
    return locals()[architecture.casefold()](in_channels, out_classes, pretrained)
